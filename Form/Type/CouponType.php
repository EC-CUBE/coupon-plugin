    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('coupon_cd', TextType::class, [
                'label' => 'coupon.admin.label.coupon_cd',
                'required' => true,
                'trim' => true,
                'constraints' => [
                    new Assert\NotBlank(),
            ...
            ->add('coupon_name', TextType::class, [
                'label' => 'coupon.admin.label.coupon_name',
                'required' => true,
                'trim' => true,
                'constraints' => [
                    new Assert\NotBlank(),
            ...
            ->add('coupon_type', ChoiceType::class, [
                'choices' => array_flip([
                    Coupon::PRODUCT => 'coupon.admin.coupon_type.product',
                    Coupon::CATEGORY => 'coupon.admin.coupon_type.category',
                    Coupon::ALL => 'coupon.admin.coupon_type.all',
                ]),
                'required' => true,
                'expanded' => true,
                'multiple' => false,
                'label' => 'coupon.admin.label.coupon_type',
                'constraints' => [
                    new Assert\NotBlank(),
                ],
            ])
            ->add('coupon_member', ChoiceType::class, [
                'choices' => array_flip([
                    1 => 'coupon.admin.coupon_member.yes',
                    0 => 'coupon.admin.coupon_member.no',
                ]),
                'required' => true,
                'expanded' => true,
                'multiple' => false,
                'label' => 'coupon.admin.label.coupon_member',
                'constraints' => [
                    new Assert\NotBlank(),
                ],
            ])
            ->add('discount_type', ChoiceType::class, [
                'choices' => array_flip([
                    Coupon::DISCOUNT_PRICE => 'coupon.admin.label.discount_type.price',
                    Coupon::DISCOUNT_RATE => 'coupon.admin.label.discount_type.rate',
                ]),
                'required' => true,
                'expanded' => true,
                'multiple' => false,
                'label' => 'coupon.admin.label.discount_type',
                'constraints' => [
                    new Assert\NotBlank(),
                ],
            ])
            ->add('coupon_lower_limit', MoneyType::class, [
                'label' => 'coupon.admin.label.coupon_lower_limit',
                'required' => false,
                'currency' => $currency,
                'constraints' => [
                    new Assert\Range([
            ...
            ->add('discount_price', MoneyType::class, [
                'label' => 'coupon.admin.label.discount_price',
                'required' => false,
                'currency' => $currency,
                'constraints' => [
                    new Assert\Range([
            ...
            ->add('discount_rate', IntegerType::class, [
                'label' => 'coupon.admin.label.discount_rate',
                'required' => false,
                'constraints' => [
                    new Assert\Range([
                        'min' => 1,
            ...
            ->add('available_from_date', DateType::class, [
                'label' => 'coupon.admin.label.available_from_date',
                'required' => true,
                'input' => 'datetime',
                'widget' => 'single_text',
                'constraints' => [
            ...
            ->add('available_to_date', DateType::class, [
                'label' => 'coupon.admin.label.available_to_date',
                'required' => true,
                'input' => 'datetime',
                'widget' => 'single_text',
                'constraints' => [
            ...
            ->add('coupon_release', IntegerType::class, [
                'label' => 'coupon.admin.label.coupon_release',
                'required' => true,
                'constraints' => [
                    new Assert\NotBlank(),
                    new Assert\Range([
            ...
            ->addEventListener(FormEvents::POST_SUBMIT, function (FormEvent $event) {
                ...
                if (count($data['CouponDetails']) == 0 && $data['coupon_type'] != Coupon::ALL) {
                    $form['coupon_type']->addError(new FormError(trans('coupon.admin.coupontype')));
                }
                ...
                if (!empty($data['available_from_date']) && !empty($data['available_to_date'])) {
                    ...
                    if ($fromDate->gt($toDate)) {
                        $form['available_from_date']->addError(new FormError('coupon.admin.avaiabledate'));
                    }
                }
            });
    }
